        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AiCommand = table.Column<string>(type: "TEXT", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AiDbCommands", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PersonSubject", x => new { x.PersonsId, x.SubjectsId });
                    table.ForeignKey(
                        name: "FK_PersonSubject_Persons_PersonsId",
                        column: x => x.PersonsId,
                        principalTable: "Persons",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PersonSubject_Subjects_SubjectsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PersonSubject_SubjectsId",
                table: "PersonSubject",
                column: "SubjectsId");
